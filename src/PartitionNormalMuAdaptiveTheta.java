...
public class PartitionNormalMuAdaptiveTheta extends Partition<DistributionNormalMuComparable> {

    //private double theta = 1;
    private double step = 1;

    public PartitionNormalMuAdaptiveTheta(String filepath) {
