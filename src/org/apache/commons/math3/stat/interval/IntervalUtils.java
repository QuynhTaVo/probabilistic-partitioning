 ...
 * <li>DistributionNormal approximation (based on central limit theorem)</li>
...
public final class IntervalUtils {
     ...
     * trials, successes and confidence level using the DistributionNormal approximation to
